...
template <typename char_type, typename size_type, size_type max_size, bool NulTerminate>
struct hash<hamtori::basic_sstring<char_type, size_type, max_size, NulTerminate>> {
    size_t operator()(const hamtori::basic_sstring<char_type, size_type, max_size, NulTerminate>& s) const {
        return std::hash<hamtori::compat::basic_string_view<char_type>>()(s);
    }
};
